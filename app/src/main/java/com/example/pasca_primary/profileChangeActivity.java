...
public class profileChangeActivity extends AppCompatActivity {
    ...
    private void openCamera() {
        ...
        imageUri = profileChangeActivity.this.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
    ...
    private void Permissions() {
        ...
        Dexter.withContext(profileChangeActivity.this)
                .withPermissions(
