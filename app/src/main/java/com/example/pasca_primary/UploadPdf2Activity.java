...
public class UploadPdf2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_pdf2_activity);
        ...
        Okay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UploadPdf2Activity.this, "Finish", Toast.LENGTH_SHORT).show();
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadPdf2Activity.this, "Book Uploaded!!", Toast.LENGTH_SHORT).show();
